...
/**
 * Comilla Board 2023 - Biology 2nd Paper (MCQ)
 * 25 questions
 */
export const comilla2023Bio2nd: Question[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    category: "Biology 2nd Paper",
    explanations: {
      "১৮.৫–২৪.৯৯ কেজি/$m^2$": "এটি স্বাভাবিক BMI।",
      "২৫.০–২৯.৯৯ কেজি/$m^2$": "এটি অতিরিক্ত ওজন (Overweight) এর BMI।",
      "৩০.০–৩৪.৯৯ কেজি/$m^2$": "এটি স্থূলতা (Obese Class I) এর BMI।",
      "৩৫.০–৩৯.৯৯ কেজি/$m^2$": "এটি গুরুতর স্থূলতা (Obese Class II) এর BMI।"
    }
  },
  {
    id: 6,
    ...
    category: "Genetics",
    explanations: {
      "অসম্পূর্ণ প্রকটতা": "এটি যখন একটি অ্যালিল অন্যটির উপর সম্পূর্ণ প্রভাব ফেলতে পারে না।",
      "পরিপূরক জিন": "এটি যখন দুটি জিন মিলে স্বাভাবিক ফিনোটাইপ তৈরি করে।",
      "প্রকট এপিস্ট্যাসিস": "সঠিক উত্তর। একটি জিনের প্রকট অ্যালিল অন্য জিনের প্রকাশকে বাধা দেয়।",
      "সম-প্রকটতা": "এটি যখন দুটি অ্যালিল সমান প্রভাব ফেলে।"
    }
  },
  {
    id: 7,
    ...
    category: "Genetics",
    explanations: {
      "৯:৩:৩:১": "এটি সম্পূর্ণ প্রভাবের অনুপাত।",
      "৯:৭": "এটি পরিপূরক জিনের অনুপাত।",
      "১৩:৩": "সঠিক উত্তর। এটি প্রকট এপিস্ট্যাসিসের অনুপাত।",
      "১:২:১": "এটি অসম্পূর্ণ প্রকটতার অনুপাত।"
    }
  },
  {
    id: 8,
    ...
    explanations: {
      "৮": "সঠিক উত্তর। করোতিকায় ৮টি অস্থি থাকে।",
      "১৪": "এটি কব্জির হাড়ের সংখ্যা।",
      "২৫": "মেরুদণ্ডের প্রথম ২৫টি কশেরুকা।",
      "২৯": "খোলস বা কঙ্কালের অন্যান্য অংশ।"
    }
  },
  {
    id: 9,
    ...
    explanations: {
      "Platyhelminthes": "এটি সমতল কৃমি পর্ব।",
      "Mollusca": "সঠিক উত্তর। শামুক Mollusca পর্বের প্রাণী।",
      "Annelida": "এটি বলয় কৃমি পর্ব।",
      "Arthropoda": "এটি সন্ধিপদ পর্ব।"
    }
  },
  {
    id: 10,
    ...
    category: "Animal Diversity",
    explanations: {
      "i ও ii": "ভুল উত্তর। তারামাছে চলন অঙ্গ নালিকাপদ আছে।",
      "i ও iii": "ভুল উত্তর। তারামাছে রক্ত সংবহনতন্ত্র উপস্থিত।",
      "ii ও iii": "সঠিক উত্তর। তারামাছে রক্ত সংবহনতন্ত্র ও নালিকাপদ আছে।",
  ...
  },
  {
    ...
    explanations: {
      "i ও ii": "ভুল উত্তর। হৃদপেশিতে ইন্টারক্যালেটেড ডিস্ক আছে।",
      "i ও iii": "ভুল উত্তর। হৃদপেশি শাখাযুক্ত।",
      "ii ও iii": "ভুল উত্তর। হৃদপেশি অনৈচ্ছিক।",
      "i, ii ও iii": "সঠিক উত্তর। হৃদপেশি অনৈচ্ছিক, শাখাযুক্ত এবং ইন্টারক্যালেটেড ডিস্কযুক্ত।"
    }
  },
  {
    id: 12,
    ...
    category: "Human Physiology",
    explanations: {
      "পনস": "সঠিক উত্তর। পনসে শ্বসনকেন্দ্র অবস্থিত।",
      "সেরিবেলাম": "সেরিবেলাম সমন্বয় ও ভারসাম্য নিয়ন্ত্রণ করে।",
      "সেরিব্রাম": "সেরিব্রাম উচ্চ মানসিক কার্যকলাপ নিয়ন্ত্রণ করে।",
      "মধ্য মস্তিষ্ক": "মধ্য মস্তিষ্ক দৃষ্টি ও শ্রবণ নিয়ন্ত্রণ করে।"
    }
  },
  {
    id: 13,
  ...
  },
  {
    ...
    explanations: {
      ...
      "Branchiostoma": "এটি নটোকর্ড জাতীয় প্রাণী, এদের আঁইশ থাকে না।"
    }
  },
  {
    id: 25,
    ...
    category: "Human Physiology",
    explanations: {
      "i ও ii": "ভুল উত্তর। হায়ালিন তরুণাস্থির ম্যাট্রিক্স স্বচ্ছ।",
      "i ও iii": "ভুল উত্তর। হায়ালিন তরুণাস্থি তন্তুবহীন।",
      "ii ও iii": "সঠিক উত্তর। হায়ালিন তরুণাস্থি তন্তুবহীন এবং নমনীয়।",
      "i, ii ও iii": "ভুল উত্তর।"
    }
  }
];
