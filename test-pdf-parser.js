...
const { generateId, addImportRecord, loadAppData, saveAppData } = require('./src/utils/routineStorage');

// Configure pdfjs-dist
pdfjsLib.GlobalWorkerOptions.workerSrc = path.resolve(__dirname, 'node_modules', 'pdfjs-dist', 'build', 'pdf.worker.min.mjs');
...
async function testPDFParser() {
  try {
    const pdfPath = path.resolve(__dirname, '1846.pdf');
